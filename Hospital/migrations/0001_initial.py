    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(max_length=40)),
                ('mobile', models.CharField(max_length=20, null=True)),
                ('department', models.CharField(choices=[('Cardiologo', 'Cardiologo'), ('Dermatologo', 'Dermatologo'), ('Especialista en medicina de urgencias', 'Especialista en medicina de urgencias'), ('Alergologo/Inmunologo', 'Alergologo/Inmunologo'), ('Anestesiologo', 'Anestesiologo'), ('Cirujanos de colon y recto', 'Cirujanos de colon y recto')], default='Cardiologo', max_length=50)),
                ('status', models.BooleanField(default=False)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
