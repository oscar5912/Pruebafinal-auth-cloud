...
#para mostrar el botón de registro/iniciar sesión para el administrador (por sumit)
...
#para mostrar el botón de registro/iniciar sesión para el doctor (por sumit)
...
#para mostrar el botón de registro/iniciar sesión para el paciente (por sumit)
...
#-----------para verificar que el usuario es médico, paciente o administrador (por sumit)
def is_admin(user):
...
#---------DESPUÉS DE INGRESAR LAS CREDENCIALES VERIFICAMOS SI EL NOMBRE DE USUARIO Y LA CONTRASEÑA SON DE ADMIN, DOCTOR O PACIENTE
...
#---------------------------------------------------------------------------------
#------------------------ VISTAS RELACIONADAS CON EL ADMINISTRADOR INICIO ------------------------------
#---------------------------------------------------------------------------------
...
#------------------PARA APROBAR AL PACIENTE POR PARTE DEL ADMIN----------------------
@login_required(login_url='adminlogin')
@user_passes_test(is_admin)
...
def discharge_patient_view(request,pk):
    ...
    if request.method == 'POST':
       ...
       #para actualizar la base de datos Detalles de alta del paciente (pdf)
...
#--------------para descargar e imprimir la factura del paciente de alta (pdf)
import io
...
#---------------------------------------------------------------------------------
#------------------------ VISTAS RELACIONADAS CON EL PACIENTE INICIO ------------------------------
#---------------------------------------------------------------------------------
...
def search_doctor_view(request):
    patient=models.Patient.objects.get(user_id=request.user.id)#para la foto de perfil del paciente en la barra lateral
    
   # cualquier usuario que escriba en el cuadro de búsqueda obtenemos la consulta
    query = request.GET['query']
